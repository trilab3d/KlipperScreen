...
class FineTunePanel(ScreenPanel):
    ...
    def __init__(self, screen, title):
        ...
        grid.attach(self.labels['extrudefactor'], 1, 2, 1, 1)
        grid.attach(self.labels['extrude+'], 2, 2, 1, 1)
        grid.attach(self.labels['extruder-'], 0, 3, 1, 1)
        grid.attach(self.labels['extruder'], 1, 3, 1, 1)
        grid.attach(self.labels['extruder+'], 2, 3, 1, 1)
        grid.attach(self.labels['heater_bed-'], 0, 4, 1, 1)
        grid.attach(self.labels['heater_bed'], 1, 4, 1, 1)
        grid.attach(self.labels['heater_bed+'], 2, 4, 1, 1)
        grid.attach(self.labels['heater_chamber-'], 0, 5, 1, 1)
        grid.attach(self.labels['heater_chamber'], 1, 5, 1, 1)
        grid.attach(self.labels['heater_chamber+'], 2, 5, 1, 1)
