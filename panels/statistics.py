...
class StatisticsPanel(ScreenPanel):
    def __init__(self, screen, title):
        ...
        self.total_jobs_lbl = Gtk.Label(label="Total jobs:")
        ...
        self.total_time_lbl = Gtk.Label(label="Total time:")
        ...
        self.total_print_time_lbl = Gtk.Label(label="Total print time:")
        ...
        self.total_filament_lbl = Gtk.Label(label="Filament consumed:")
        ...
        self.total_grid.attach(self.total_filament_lbl, 2, 0, 1, 1)
        self.total_grid.attach(self.total_filament_val, 3, 0, 1, 1)

        self.longest_job_lbl = Gtk.Label(label="Longest job:")
        ...
        self.total_grid.attach(self.longest_job_lbl, 2, 1, 1, 1)
        self.total_grid.attach(self.longest_job_val, 3, 1, 1, 1)

        self.longest_print_lbl = Gtk.Label(label="Longest print:")
        ...
        self.total_grid.attach(self.longest_print_lbl, 2, 2, 1, 1)
        self.total_grid.attach(self.longest_print_val, 3, 2, 1, 1)
